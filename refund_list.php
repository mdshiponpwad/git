    ...
    <div class="offcanvas offcanvas-start sidebar-nav bg-light text-dark " id="sidebar">
        ...
        <div class="collapse" id="routeId">
            <div class="card card-body bg-light text-dark p-1 m-1">
                ...
                <a class="dropdown-item text-start " href="update_route.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00'" onmouseout="this.style.color='#000'">Update Bus Info</a>
            </div>
        </div>
        <!-----------route End--------------->
        <!-----------Booking Start--------------->
        ...
        <div class="collapse" id="bookingId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="booking_list.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00'" onmouseout="this.style.color='#000'">BUS LIST</a>
                <a class=" dropdown-item text-start " href="add_booking.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Add Bus</a>
                <a class="dropdown-item text-start " href="update_booking.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update Bus Info</a>
            </div>
        </div>
        <!-----------Booking End--------------->
        <!-----------user Start--------------->
        ...
        <div class="collapse" id="userId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="agent_list.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">BUS LIST</a>
                <a class=" dropdown-item text-start " href="add_agent.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Add Bus</a>
                <a class="dropdown-item text-start " href="update_agent.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update Bus Info</a>
            </div>
        </div>
        <!-----------User End--------------->
        <!-----------refund Start--------------->
        ...
        <div class="collapse" id="accId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="account_list.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00'" onmouseout="this.style.color='#000'">BUS LIST</a>
