...
<body>
    ...
    <div class="offcanvas offcanvas-start sidebar-nav bg-light text-dark " id="sidebar">
        ...
        <div class="collapse" id="routeId">
            <div class="card card-body bg-light text-dark p-1 m-1">
                ...
                <a class="dropdown-item text-start " href="update_route.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update Route Info</a>
            </div>
        </div>
        <!-----------route End--------------->
        <!-----------Booking Start--------------->
        ...
        <!-----------Passenger Start--------------->
        <center>
            <a class="btn btn-primary p-1 m-1 " data-bs-toggle="collapse" href="#passengerId" role="button" aria-expanded="false" aria-controls="collapseExample" style="width:90% ;">Customer </a>
        </center>

        <div class="collapse" id="passengerId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="passenger_list.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">BUS LIST</a>
                <a class=" dropdown-item text-start " href="add_passenger.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Add Bus</a>
                <a class="dropdown-item text-start " href="update_passenger.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update Bus Info</a>
            </div>
        </div>
        <!-----------Passenger  End--------------->
        <!-----------Discount Start--------------->
    ...
    <h2>Bus</h2>
        <div class="container-fluid tab" style="overflow-x:scroll;">
