    ...
    <div class="offcanvas offcanvas-start sidebar-nav bg-light text-dark " id="sidebar">
        ...
        <div class="collapse" id="routeId">
            <div class="card card-body bg-light text-dark p-1 m-1">
                ...
                <a class="dropdown-item text-start " href="# " style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update Routte</a>
            </div>
        </div>
        <!-----------route End--------------->
        <!-----------Booking Start--------------->
        ...
        <div class="collapse" id="bookingId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="#" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Booking List</a>
                ...
                <a class="dropdown-item text-start " href="# " style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update Booking</a>
            </div>
        </div>
        <!-----------Booking End--------------->
        <!-----------user Start--------------->
        ...
        <div class="collapse" id="userId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="#" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">User List</a>
                <a class=" dropdown-item text-start " href="# " style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Add user</a>
                <a class="dropdown-item text-start " href="# " style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update User</a>
            </div>
        </div>
        <!-----------User End--------------->
        <!-----------refund Start--------------->
        ...
        <div class="collapse" id="accId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="#" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Account info</a>
        ...
        <div class="collapse" id="counterId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="#" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Counter info</a>
                ...
                <a class="dropdown-item text-start " href="# " style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update update Info</a>
            </div>
        </div>
        <!-----------User End--------------->
        <!-----------Counter Start--------------->
