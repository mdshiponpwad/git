    ...
    <div class="offcanvas offcanvas-start sidebar-nav bg-light text-dark " id="sidebar">
        ...
        <div class="collapse" id="userId">
            <div class="bg-light text-dark p-1 m-1">
                ...
                <a class="dropdown-item text-start" href="update_agent.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00'" onmouseout="this.style.color='#000'">Update Agent</a>
            </div>
        </div>
        <!-----------User End--------------->
        <!-----------refund Start--------------->
