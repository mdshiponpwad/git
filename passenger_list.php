...
<body>
    ...
    <div class="offcanvas offcanvas-start sidebar-nav bg-light text-dark " id="sidebar">
        ...
        <!-----------Bus start--------------->
        <center><a class="btn btn-primary p-1 m-1" href="dashboard.php" data-bs-toggle="collapse" href="#busId" role="button" aria-expanded="false" aria-controls="collapseExample" style="width:90% ;">Bus</a></center>
        ...
        <div class="collapse" id="userId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="agent_list.php Active" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Agent LIST</a>
                ...
                <a class="dropdown-item text-start " href="update_agent " style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update Agent Info</a>
        ...
        <!-----------passenger Start--------------->
        <center>
            <a class="btn btn-primary p-1 m-1 " data-bs-toggle="collapse" href="#accId" role="button" aria-expanded="false" aria-controls="collapseExample active" style="width:90% ;">passenger</a>
        </center>

        <div class="collapse" id="accId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="passenger_list.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Account LIST</a>
                <a class=" dropdown-item text-start " href="add_passenger.php " style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Add Account</a>
                <a class="dropdown-item text-start " href="update_passenger.php " style="background-color: ivory ;" onmouseover="this.style.color='#00FF00'" onmouseout="this.style.color='#000'">Update Account</a>
            </div>
        </div>
        <!-----------account  End--------------->
        <!-----------Counter Start--------------->
        ...
        <div class="collapse" id="customerId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="customer_list.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00'" onmouseout="this.style.color='#000'">Customer LIST</a>
                <a class=" dropdown-item text-start " href="add_customer.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00'" onmouseout="this.style.color='#000'">Add Customer</a>
                <a class="dropdown-item text-start " href="update_customer.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update Customer</a>
            </div>
        </div>
        <!-----------Customer  End--------------->
        <!-----------Discount Start--------------->
    ...
    <h2>Bus</h2>
        <div class="container-fluid tab" style="overflow-x: auto;">
  <table class="tb table table-striped table-bordered table-hover mt-3 " >
    ...
    <tr>
        ...
        <a href=""><i class="bi bi-pen text-info"></i></a>
        </td>
    </tr>
    </tbody>
</table>
