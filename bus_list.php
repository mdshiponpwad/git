    ...
    <div class="offcanvas offcanvas-start sidebar-nav bg-light text-dark " id="sidebar">
        <div class="offcanvas-body p-0 flex-grow-0 ">
            <center>
                ...
                <a class="btn btn-dark w-100  text-light" role="button"  href="dashboard.php" aria-expanded="false" aria-controls="collapseExample">Dashboard</a>
            </center>
        ...
        <div class="collapse" id="bookingId">
            <div class="bg-light text-dark p-1 m-1">
                <a class="dropdown-item text-start" href="booking_list.php" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">BookingLIST</a>
        ...
        <div class="collapse" id="refundId">
            <div class="bg-light text-dark p-1 m-1">
                ...
                <a class="dropdown-item text-start " href="update_refund" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update Refund Info</a>
            </div>
        </div>
        <!-----------User End--------------->
        <!-----------account Start--------------->
        ...
        <div class="collapse" id="accId">
            <div class="bg-light text-dark p-1 m-1">
                ...
                <a class=" dropdown-item text-start " href="add_account " style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Add Account</a>
                <a class="dropdown-item text-start " href="update_account" style="background-color: ivory ;" onmouseover="this.style.color='#00FF00	'" onmouseout="this.style.color='#000'">Update Account Info</a>
            </div>
        </div>
        <!-----------account  End--------------->
        <!-----------Counter Start--------------->
